		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "La confirmación del abastecimiento de línea.",
									"targetURL": "#andinasagaconfabs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"andinasagaconfabs-display": {
								"semanticObject": "andinasagaconfabs",
								"action": "display",
								"description": "La confirmación del abastecimiento de línea.",
								"title": "La confirmación del abastecimiento de línea.",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=andina.sagaconfabs",
									"url": sap.ui.require.toUrl("andina/sagaconfabs")
								}
							}
						}
					}
